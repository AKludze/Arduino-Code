...
//  const int k = 3;
    ...
    //delay(10);
      ...
      Serial.println(i);
      if (i > 1){
        runXStepperLengthFull();
      }
      if (i < 1){
        runXStepperLengthPercentWise();
        Serial.println("helpme");
   
      //
      
      //Serial.println("Finished Running Full Length"); 
      //continue;
    }
  }
...
//
//percent -> 
//range_intial * percent 
//for i <= full_range number -> go many steps
//for i greater than 100> this many steps .99
//  for (int j = 2; j > 0; j=j-1) {
//    //delay(10);
//    Serial.println(j);
//    Serial.println("Half");
//    if (j > 0){
//      runXStepperLengthHalf();
//    }
//    else{
//      Serial.println("Finished Running Full Length"); 
//      //continue;
...
void runXStepperLengthFull(){
  ...
  //delay(100);
  stepperX.moveRelativeInSteps(L * 10);
  //delay(2000);
  ...
  stepperX.setAccelerationInStepsPerSecondPerSecond(100);
  //delay(100);
  stepperX.moveRelativeInSteps(-1 * L * 10);
  //delay(2000);
  
}


void runXStepperLengthPercentWise(){
  
      stepperX.setSpeedInStepsPerSecond(800);
      stepperX.setAccelerationInStepsPerSecondPerSecond(100);
      //delay(100);
      stepperX.moveRelativeInSteps(L * 10 * (1-k/100) );
      //delay(2000);
      stepperX.setSpeedInStepsPerSecond(800);
      stepperX.setAccelerationInStepsPerSecondPerSecond(100);
      //delay(100);
      stepperX.moveRelativeInSteps(-1 * L * 10 * (1-k/100) );
      k = k + 1;
      //delay(2000);
}

void runXStepperLengthHalf(){
  ...
  stepperX.setAccelerationInStepsPerSecondPerSecond(10);
  stepperX.moveRelativeInSteps(L * 10 * 50/100);
  //delay(2000);
  ...
  stepperX.moveRelativeInSteps(-1 * L * 10 * 50/100);
  //delay(2000);
  
}


void runXStepperLengthQuarter(){
  ...
  stepperX.setSpeedInStepsPerSecond(800);
  stepperX.setAccelerationInStepsPerSecondPerSecond(100);
  stepperX.moveRelativeInSteps(L * 10 * 25/100);
  //delay(2000);
  ...
  stepperX.setSpeedInStepsPerSecond(800);
  stepperX.setAccelerationInStepsPerSecondPerSecond(10);
  stepperX.moveRelativeInSteps(-1 * L * 10 *  25/100);
  //delay(2000);
